...
def render_page(content_template: str, status: int = 200, **context: Any) -> bytes:
    html = render_layout(content_template, **context)
    return build_response(status, html.encode("utf-8"), content_type="text/html; charset=utf-8")